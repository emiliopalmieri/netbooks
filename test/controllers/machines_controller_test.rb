...
class MachinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create machine" do
    assert_difference('Machine.count') do
      post machines_url, params: { machine: { macAddress: @machine.macAddress, observations: @machine.observations, owner_id: @machine.owner_id, serial: @machine.serial } }, as: :json
    end
  ...
  test "should update machine" do
    patch machine_url(@machine), params: { machine: { macAddress: @machine.macAddress, observations: @machine.observations, owner_id: @machine.owner_id, serial: @machine.serial } }, as: :json
    assert_response 200
  end
